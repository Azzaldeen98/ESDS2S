...
class SpeechRecognizerService(private val context: Context,
    ...
    fun  initialization(recognizer: Boolean=true, workingInTheContinuously: Boolean=false,lang:String?="ar",errorListener:OnErrorListener?=null):SpeechRecognizer? {
...
//            Log.d("onRmsChanged", v.toString())
        ...
        override fun onError(i: Int) {
            ...
            Log.e( "onError:", "$i")
            if( mOnErrorListener!=null) mOnErrorListener?.onError(i)
...
class SpeechRecognizerService2(private val context: Context,
...
//                    }
                ...
                override fun onResults(bundle: Bundle) {
                    ...
                    if(this@SpeechRecognizerService2.context==null)
                        Log.e("Error","context object is null")
                    else
                        Toast.makeText(this@SpeechRecognizerService2.context,textSpeachResult, Toast.LENGTH_SHORT).show()
