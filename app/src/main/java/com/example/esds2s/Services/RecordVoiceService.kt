...
//                else{ LANG= ExternalStorage.getValue(this@RecordVoiceService3,ContentApp.LANGUAGE).toString() }
//            }
        } catch (e:Exception){
...
//
//                            val player = audioPlayer?.startFromRowResource(this@RecordVoiceService3, sound_id) ?: null
